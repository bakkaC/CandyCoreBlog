...
![](assets/文档bug相关记录/images/文档bug相关记录-image-3.png)
...
![这里绿色是为了还原测试旧代码，实际上这是被删去的代码](assets/文档bug相关记录/images/文档bug相关记录-image-5.png)
...
![](assets/文档bug相关记录/images/文档bug相关记录-image-4.png)

![](assets/文档bug相关记录/images/文档bug相关记录-image-7.png)
...
* 也就是上述的第十步之后，dom挂载发生在createEmbeddedAffineEditor()内部，把style相关内容设置完之后给外部发送render-ready的消息
  ...
  ![](assets/文档bug相关记录/images/文档bug相关记录-image-2.png)
...
* 而宿主组件监听这个消息，设置loading状态就可以了
  ...
  ![](assets/文档bug相关记录/images/文档bug相关记录-image-6.png)
...
![](assets/文档bug相关记录/images/文档bug相关记录-image-1.png)
...
![](assets/文档bug相关记录/images/文档bug相关记录-image.png)
